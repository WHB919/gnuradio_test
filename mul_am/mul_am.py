...
class mul_am(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "mul_am")
        ...
        self.analog_sig_source_x_0_1_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 2000, 1, 0, 0)
        self.analog_sig_source_x_0_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 3000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_1_0, 0), (self.blocks_add_xx_0, 1))
...
def main(top_block_cls=mul_am, options=None):
